...
<?php
		...
		if ($count1 == 0) {
			if ($password == $password1) {
				$conn->query("insert into voters(id_number, password, firstname,lastname, gender,othername,status, date) VALUES('$id_number', '".md5($password)."','$firstname','$lastname', '$othername','$gender', 'Unvoted', '$date')");
			?>
	            <script>
