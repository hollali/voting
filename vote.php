...
<body>
	...
	<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
						...
						?>
                           <div id = "position">
							...
							<center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><br><strong>Party: </strong> ".$fetch['party']?></center>
		...
		<div id = "position">
		    ...
		    <center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<strong>Party: </strong> ".$fetch['party']?></center>
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
			...
			<center>Information Secretary</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
				...
				?>
						<div id = "position">
							<center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px;" height = "150px" width = "150px" class = "img"></center>
						<center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Party: </strong> ".$fetch['party']?></center>
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Regional Secretary</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Regional Chairman</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Woman's Organizer</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>General Youth Organizer</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Presiding Member</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
     ...
     <div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Committee Member</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
